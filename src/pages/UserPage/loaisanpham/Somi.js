...
function Somi({ match }) {
  ...
  const listSomi = listKhoQuanAo.filter(item => item.loaisanphamId === 5);
  ...
  function renderTatCaSomi(listSomi) {
  ...
  let listSanPhamTshirtTangDan = _.orderBy(listSomi, ['price'], ['asc']);
  let listSanPhamTshirtGiamDan = _.orderBy(listSomi, ['price'], ['desc']);
  let listSanPhamTshirtMoiNhat = listSomi.filter(item => item.sanphamduocId === 6);
  let listSanPhamTshirtCuNhat = listSomi.filter(item => item.sanphamduocId === 5);
        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-12 a-left">
              <p> Trang chủ &ensp;  <i class="fa fa-chevron-right" aria-hidden="true"></i> &ensp;  <span>SƠ MI</span></p>
            </div>
