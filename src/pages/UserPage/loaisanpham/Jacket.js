...
function Jacket({ match }) {
  const listKhoQuanAo = useSelector(state => state.quanlyKhoAoQuan.list);
  const listJacket = listKhoQuanAo.filter(item => item.loaisanphamId === 4);
  ...
  function renderTatCaJacket(listJacket) {
  ...
  let listSanPhamTshirtTangDan = _.orderBy(listJacket, ['price'], ['asc']);
  let listSanPhamTshirtGiamDan = _.orderBy(listJacket, ['price'], ['desc']);
  let listSanPhamTshirtMoiNhat = listJacket.filter(item => item.sanphamduocId === 6);
  let listSanPhamTshirtCuNhat = listJacket.filter(item => item.sanphamduocId === 5);
        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-12 a-left">
              <p> Trang chủ &ensp;  <i class="fa fa-chevron-right" aria-hidden="true"></i> &ensp;  <span>JACKET</span></p>
            </div>
            <div className="main_container collection col-md-12 col-lg-12">
              ...
              <div className="row renderProductAll">
                {renderTatCaJacket(listJacket)}
              </div>
              <Row justify="center">
                {lengthRender !== listJacket.length && listJacket.length > 0 ?
                  <Button
