...
function Caphat({ match }) {
  const listKhoQuanAo = useSelector(state => state.quanlyKhoAoQuan.list);
  const listCaphat = listKhoQuanAo.filter(item => item.loaisanphamId === 7);
  ...
  function renderTatCaCaphat(listCaphat) {
  ...
  let listSanPhamTshirtTangDan = _.orderBy(listCaphat, ['price'], ['asc']);
  let listSanPhamTshirtGiamDan = _.orderBy(listCaphat, ['price'], ['desc']);
  let listSanPhamTshirtMoiNhat = listCaphat.filter(item => item.sanphamduocId === 6);
  let listSanPhamTshirtCuNhat = listCaphat.filter(item => item.sanphamduocId === 5);
        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-12 a-left">
              <p> Trang chủ &ensp;  <i class="fa fa-chevron-right" aria-hidden="true"></i> &ensp;  <span>NÓN</span></p>
            </div>
            <div className="main_container collection col-md-12 col-lg-12">
              ...
              <div className="row renderProductAll">
                {renderTatCaCaphat(listCaphat)}
              </div>
              {/* <Row justify="center">
                {lengthRender !== listCaphat.length && listCaphat.length > 0 ?
                  <Button
