...
function Hoodie({ match }) {
  const listKhoQuanAo = useSelector(state => state.quanlyKhoAoQuan.list);
  const listHoodie = listKhoQuanAo.filter(item => item.loaisanphamId === 3);
  ...
  function renderTatCaHoodies(listHoodie) {
  ...
  let listSanPhamTshirtTangDan = _.orderBy(listHoodie, ['price'], ['asc']);
  let listSanPhamTshirtGiamDan = _.orderBy(listHoodie, ['price'], ['desc']);
  let listSanPhamTshirtMoiNhat = listHoodie.filter(item => item.sanphamduocId === 6);
  let listSanPhamTshirtCuNhat = listHoodie.filter(item => item.sanphamduocId === 5);
        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-12 a-left">
              <p> Trang chủ &ensp;  <i class="fa fa-chevron-right" aria-hidden="true"></i> &ensp;  <span>HOODIE</span></p>
            </div>
            <div className="main_container collection col-md-12 col-lg-12">
              ...
              <div className="row renderProductAll">
                {renderTatCaHoodies(listHoodie)}
              </div>
              <Row justify="center">
                {lengthRender !== listHoodie.length && listHoodie.length > 0 ?
                  <Button
